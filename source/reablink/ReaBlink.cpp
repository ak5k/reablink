...
void registerReaBlink()
{
    ...
    plugin_register(
        "API_Blink_GetStartStopSyncEnabled",
    ...
    plugin_register(
        "API_Blink_SetStartStopSyncEnabled",
    ...
    plugin_register(
        "APIdef_Blink_GetTimeForPlaying",
    ...
    plugin_register(
        "API_Blink_SetBeatAtTimeRequest",
